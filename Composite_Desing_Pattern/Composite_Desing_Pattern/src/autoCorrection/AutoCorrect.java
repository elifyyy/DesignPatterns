...
public class AutoCorrect {
    ...
    private String wordsFileName = "src\\autoCorrection\\words.txt"; // Word list text file
    ...
    public String autoCorrect(String textWord) {
        ...
        // Else, check if the text's word is an anagram of a dictionary word
            ...
            if (suggestions.isEmpty()) {
            	...
            	String suggestion = "";
                if (!suggestions.isEmpty()) {
                    suggestion = suggestions.pop(); //WE CHANGED HERE,IT RETURNS ONLY FIRST SUGGESTION.
                }
                return suggestion;
            }
        }
